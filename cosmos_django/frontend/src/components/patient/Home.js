...
var Home = /** @class */ (function (_super) {
    ...
    function Home(props) {
        ...
        _this.handleVerticalNavbarOpen = _this.handleVerticalNavbarOpen.bind(
            _this
        );
        _this.handleVerticalNavbarClose = _this.handleVerticalNavbarClose.bind(
            _this
        );
        return _this;
    }
    Home.prototype.handleVerticalNavbarOpen = function () {
        this.setState(
            __assign(__assign({}, this.state), { isVerticalNavbarOpen: true })
        );
    };
    Home.prototype.handleVerticalNavbarClose = function () {
        this.setState(
            __assign(__assign({}, this.state), { isVerticalNavbarOpen: false })
        );
    };
    Home.prototype.componentDidMount = function () {
        var self = this;
        patientApi.getAccount(this.props.history).then(function (response) {
                ...
                React.createElement(
                    AppBar_1.default,
                    {
                        ...
                        className: clsx_1.default(
                            ...
                            (_a[
                                classes.appBarShift
                            ] = this.state.isVerticalNavbarOpen),
                            _a)
                        ),
                    },
                    React.createElement(
                ...
                React.createElement(
                    Drawer_1.default,
                    {
                        ...
                        className: clsx_1.default(
                            ...
                            (_c[classes.drawerClose] = !this.state
                        ...
                        classes: {
                            paper: clsx_1.default(
                                ...
                                (_d[classes.drawerClose] = !this.state
                                    .isVerticalNavbarOpen),
                                _d)
                            ),
                        },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            IconButton_1.default,
                            { onClick: this.handleVerticalNavbarClose },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(Header_1.default, {
                            profilePicture: this.state.account.patient_profile
                                .profile_picture,
                            firstName: this.state.account.patient_profile
                                .first_name,
                            lastName: this.state.account.patient_profile
                                .last_name,
                            sex: this.state.account.patient_profile.sex,
                            age: this.state.account.patient_profile.age,
                        }),
                        React.createElement(Charts_1.default, {
                            patientProfile: this.state.account.patient_profile,
                        })
                    )
                )
            );
...
// @ts-ignore
exports.default = styles_1.withStyles(useStyles)(
    ReactRouterDOM.withRouter(Home)
);
