        ...
        return (React.createElement("div", { className: "login-signup-form-container" },
            React.createElement("div", { className: "login-signup-form-content rounded-grey-container box-shadow-container" },
                React.createElement("div", { className: "login-signup-form-content-logo-container" },
                    React.createElement("img", { src: apiEndpointConstants.TEXT, alt: "Cosmos logo with text." })),
                React.createElement("h1", null, "Sign in"),
                React.createElement("form", { className: "login-signup-form", onSubmit: this.handleLoginRequest },
                    ...
                    React.createElement("div", { className: "form-button-container" },
                        React.createElement(core_1.Button, { type: "submit", variant: "contained", color: "secondary", size: "large" }, "Next")),
                    React.createElement("div", { className: "login-signup-redirect-link-container" },
                        React.createElement(ReactRouterDOM.Link, { to: urlPathConstants.SIGNUP }, "Not an existing user? Sign up here."))))));
    };
    return LoginForm;
}(React.Component));
