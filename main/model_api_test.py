...
class TestModelApi(test.APITestCase):
    def setUp(self) -> None:
    ...
    def test_create_user_fails_email_not_provided(self):
        request_data = copy.deepcopy(test_fixtures.TEST_USER_REQUEST_DATA)
    ...
    def test_update_user_fails_not_authenticated(self):
        ...
        response = self.client.put(url,
                                   test_fixtures.TEST_USER_PUT_REQUEST_DATA,
                                   format='json')
    ...
    def test_update_user_fails_updating_email_to_existing_user(self):
        ...
        update_request_data = copy.deepcopy(
            test_fixtures.TEST_USER_PUT_REQUEST_DATA)
        ...
        view = model_api.UsersEndpoint.as_view()
    ...
    def test_update_user_succeeds(self):
        ...
        self.assertEqual(response.data['email'],
                         test_fixtures.TEST_USER_PUT_REQUEST_DATA['email'])
        self.assertEqual(
            response.data['patient_profile']['first_name'],
            test_fixtures.TEST_USER_PUT_REQUEST_DATA['patient_profile']
            ['first_name'])
        self.assertEqual(
        ...
        self.assertDictEqual(
            ...
            ['address'])
        self.assertEqual(
            response.data['patient_profile']['race'],
            test_fixtures.TEST_USER_PUT_REQUEST_DATA['patient_profile']
            ['race'])
        self.assertEqual(
    ...
    def test_create_encounter_fails_not_authenticated(self):
        ...
        response = self.client.post(url,
                                    test_fixtures.TEST_ENCOUNTER_REQUEST_DATA,
                                    format='json')
    ...
    def test_create_encounter_fails_data_not_provided(self):
        ...
        url = urls.reverse('main/encounters')
        request_data = copy.deepcopy(test_fixtures.TEST_ENCOUNTER_REQUEST_DATA)
